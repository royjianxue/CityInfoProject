...
namespace CityInfo.API.Controllers
{
    ...
    public class PointsOfInterestController : ControllerBase
    {
                                              ...
                                              ICityInfoRepository cityInfoRepository, IMapper mapper)
        {
            ...
            _logger = logger ?? 
                throw new ArgumentNullException(nameof(logger)); // checking for null
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<PointOfInterestDto>>> GetPointInterest (int cityId)
        {
                            ...
                            JsonPatchDocument<PointOfInterestForUpdateDto> patchDocument)
        {
            ...
            patchDocument.ApplyTo(pointOfInterestToPatch, ModelState); // passing in Modelstate, this will return bad request if this is no longer valid
